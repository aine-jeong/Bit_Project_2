...
<style>
  ...
  <header>
	...
	<main class="form-signin">
  	...
  	<form action="InfoEditOk.do" method="post">
    <img class="mb-4" src="image/Bean.svg" alt="" width="72" height="57">
    <h1 class="h3 mb-3 fw-normal">개인정보수정</h1>

    <div class="form-floating">
      <input type="email" class="form-control" id="floatingInput" name="email" readonly>
      <label for="floatingPassword"><h4><b>${email}</b></h4></label>
